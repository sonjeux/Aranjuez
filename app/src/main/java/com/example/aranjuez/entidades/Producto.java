...
public class Producto {
    ...
    public Producto(String id, String id_Grupo, String id_Gasto_Adicional, String id_Grupo_De_Unidad_De_Medida, String codigo_SAP, String nombre, String descripcion, String alias, String centro_De_Costo, String producto_Terminado, String estado) {
        Id = id;
        Id_Grupo = id_Grupo;
        Id_Gasto_Adicional = id_Gasto_Adicional;
        Id_Grupo_De_Unidad_De_Medida = id_Grupo_De_Unidad_De_Medida;
